...
var HomePage = (function () {
    ...
    HomePage.prototype.pickFile = function () {
        var _this = this;
        this.message = 'clicked';
        FileSavePlugin['saveFileWithPicker']('Test File Data.', function (retValue) {
            _this.zone.run(function () {
                _this.message = "Return- " + retValue;
            });
        }, function (errValue) {
            _this.zone.run(function () {
                _this.message = "XError: " + errValue;
            });
        });
    };
    HomePage.prototype.saveFile = function () {
        ...
        FileSavePlugin['saveFileLocal'](args, function (retValue) {
            _this.zone.run(function () {
                _this.message = "Return- " + retValue;
            });
        }, function (errValue) {
    ...
    HomePage.prototype.saveSharedFile = function () {
        var _this = this;
        this.message = 'clicked';
        var args = { 'filename': 'myfile.txt', 'data': 'Testing test testy' };
        FileSavePlugin['saveFileLocal'](args, function (retValue) {
            ...
            FileSavePlugin['saveFileShared'](args, function (retValue) {
                _this.zone.run(function () {
                    _this.message = "Return- " + retValue;
                });
            }, function (errValue) {
